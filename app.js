...
function migrateState(data) {
  ...
  data.gastos = (data.gastos || []).map((gasto) => ({
    operacion: "Sin clasificar",
    ...gasto,
    categoria: ["Viáticos", "Viaticos"].includes(String(gasto.categoria || "").trim())
      ? "Viaticos y Pasajes"
      : String(gasto.categoria || "").trim() === "Equipo / Herramientas"
        ? "Herramientas/Accesorios equipos"
        : gasto.categoria,
...
function formFor(type, data) {
  ...
  if (type === "gasto") {
    const categorias = ["Nomina", "Gasolina / Combustible", "IMSS", "INFONAVIT", "Impuesto sobre nominas", "Impuestos / ISR", "Telefonia Celular", "Internet", "Renta / Local", "Papeleria / Oficina", "Herramientas/Accesorios equipos", "Publicidad / Marketing", "Mantenimiento Vehiculo", "Uniforme / EPP", "Capacitacion", "RASTREO SATELITAL", "APLICACIONES Y SOFTWARE", "Viaticos y Pasajes", "Otros Gastos"];
